...
class mata_pelajaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response() ->json("mata_pelajaran Berhasil Ditambahkan");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response() ->json("mata_pelajaran Berhasil Diupdate");
    }
    ...
    public function destroy($id)
    {
        ...
        return response() ->json("mata_pelajaran Berhasil Dihapus");
    }
