...
$router->group(['prefix' => 'api'], function() use ($router) {
    ...
    //jadwal_pelajaran
    $router->get('/jadwal_pelajaran', 'jadwal_pelajaranController@index');
    $router->get('/jadwal_pelajaran/{id}', 'jadwal_pelajaranController@show');
    $router->post('/jadwal_pelajaran', 'jadwal_pelajaranController@store');
    $router->put('/jadwal_pelajaran/{id}', 'jadwal_pelajaranController@update');
    $router->delete('/jadwal_pelajaran/{id}', 'jadwal_pelajaranController@destroy');
    //kelas
